...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/victornogueira._/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:contato@victornogueira.tech)

<img src="https://komarev.com/ghpvc/?username=VictorN0gueira&color=EA4B71&style=for-the-badge&label=VISITAS+AO+PERFIL" />
...
const victor = {
  localização:  "Brasil 🇧🇷",
  foco:         ["Frontend", "Automações", "IA"],
  frontend:     ["React", "TypeScript", "JavaScript", "HTML5", "CSS3"],
  backend:      ["Python", "PHP", "PostgreSQL", "Supabase"],
  automações:   ["N8N", "Evolution API", "Typebot", "Webhooks"],
  infra:        ["Docker", "Ubuntu", "VPS", "Portainer"],
  aprendendo:   ["Machine Learning", "AI Agents", "LLMs"],
  paixão:       "Transformar processos manuais em fluxos automatizados eficientes ⚡",
};
```
...
![Typebot](https://img.shields.io/badge/Typebot-6366F1?style=for-the-badge&logo=chatbot&logoColor=white)
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:EA4B71,60:1a1035,100:0d1117&height=120&section=footer" />
